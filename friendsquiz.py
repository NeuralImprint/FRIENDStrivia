...
all\_chars = list(set(q\["char"] for q in quotes))
...
bg\_img = Image.open("friends.jpg").resize((800, 600))
self.bg\_photo = ImageTk.PhotoImage(bg\_img)
self.bg\_label = tk.Label(root, image=self.bg\_photo)
self.bg\_label.place(x=0, y=0, relwidth=1, relheight=1)
